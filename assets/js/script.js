class Slider {
    constructor(slider, autoplay = true) {
        ...
        this.slider = slider;
        // все кадры (слайды)
        this.allFrames = slider.querySelectorAll('.banner-img');
        // цепочка кадров
    ...
    init() {
        ...
        this.allFrames.forEach(frame => frame.style.width = 110/this.length + '%');
        ...
        this.frameChain.style.width = 110 * this.length + '%';
